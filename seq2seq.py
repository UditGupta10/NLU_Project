...
class Seq2SeqSummarizer(object):
    ...
    def get_weight_file_path(model_dir_path):
        return model_dir_path + '/' + Seq2SeqSummarizer.model_name + "-{epoch:02d}-{val_loss:.4f}" + '-weights.h5'
...
class Seq2SeqGloVeSummarizer(object):
    ...
    @staticmethod
    def get_weight_file_path(model_dir_path):
        return model_dir_path + '/' + Seq2SeqGloVeSummarizer.model_name + "-{epoch:02d}-{val_loss:.4f}" + '-weights.h5'
...
class Seq2SeqGloVeSummarizerV2(object):
    ...
    @staticmethod
    def get_weight_file_path(model_dir_path):
        return model_dir_path + '/' + Seq2SeqGloVeSummarizerV2.model_name + "-{epoch:02d}-{val_loss:.4f}" + '-weights.h5'
    ...
    def fit(self, Xtrain, Ytrain, Xtest, Ytest, epochs=None, batch_size=None, model_dir_path=None):
        ...
        checkpoint = [ModelCheckpoint(weight_file_path, save_best_only=True), EarlyStopping(monitor='val_loss', min_delta=0.0001, patience=10, verbose=1, mode='auto')]
        np.save(config_file_path, self.config)
