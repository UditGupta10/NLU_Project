...
from keras.layers import Embedding, Dense, Input, RepeatVector, TimeDistributed, concatenate, Merge, add, Dropout, Bidirectional
...
class OneShotRNN(object):
    ...
    def get_weight_file_path(model_dir_path):
        return model_dir_path + '/' + OneShotRNN.model_name + "-{epoch:02d}-{val_loss:.4f}" + '-weights.h5'
    ...
    def fit(self, Xtrain, Ytrain, Xtest, Ytest, epochs=None, model_dir_path=None, batch_size=None):
        ...
        checkpoint = [ModelCheckpoint(weight_file_path, save_best_only=True, monitor='val_acc')]#, EarlyStopping(monitor='val_loss', min_delta=0.0001, patience=7, verbose=1, mode='auto')]
...
class RecursiveRNN1(object):
    ...
    @staticmethod
    def get_weight_file_path(model_dir_path):
        return model_dir_path + '/' + RecursiveRNN1.model_name + "-{epoch:02d}-{val_loss:.4f}" + '-weights.h5'
    ...
    def fit(self, Xtrain, Ytrain, Xtest, Ytest, epochs=None, model_dir_path=None, batch_size=None):
        ...
        checkpoint = [ModelCheckpoint(weight_file_path, save_best_only=True, monitor='val_acc'), EarlyStopping(monitor='val_acc', min_delta=0.0001, patience=7, verbose=1, mode='auto')]
        np.save(config_file_path, self.config)
...
class RecursiveRNN2(object):
    ...
    def __init__(self, config):
        ...
        article2 = Dropout(0.2)(article1)
        #### Add Conv layer
        #article2 = Conv1D(250, 3)
        ...
        summ2 = Dropout(0.2)(summ1)
        # summ2 = Conv1D(200,3,padding='valid',activation='relu',strides=1)(summ2)
        # summ2 = GlobalMaxPooling1D()(summ2)
    ...
    @staticmethod
    def get_weight_file_path(model_dir_path):
        return model_dir_path + '/' + RecursiveRNN2.model_name + "-{epoch:02d}-{val_loss:.4f}" + '-weights.h5'
    ...
    def fit(self, Xtrain, Ytrain, Xtest, Ytest, epochs=None, model_dir_path=None, batch_size=None):
        ...
        checkpoint = [ModelCheckpoint(weight_file_path, save_best_only=True, monitor='val_acc'), EarlyStopping(monitor='val_acc', min_delta=0.0001, patience=6, verbose=1, mode='auto')]
        np.save(config_file_path, self.config)
...
class RecursiveRNN3(object):
    ...
    @staticmethod
    def get_weight_file_path(model_dir_path):
        return model_dir_path + '/' + RecursiveRNN3.model_name + "-{epoch:02d}-{val_loss:.4f}" + '-weights.h5'

    @staticmethod
    def get_config_file_path(model_dir_path):
        return model_dir_path + '/' + RecursiveRNN3.model_name + '-config.npy'

    @staticmethod
    def get_architecture_file_path(model_dir_path):
        return model_dir_path + '/' + RecursiveRNN3.model_name + '-architecture.json'
    ...
    def fit(self, Xtrain, Ytrain, Xtest, Ytest, epochs=None, model_dir_path=None, batch_size=None):
        ...
        config_file_path = RecursiveRNN3.get_config_file_path(model_dir_path)
        weight_file_path = RecursiveRNN3.get_weight_file_path(model_dir_path)
        checkpoint = [ModelCheckpoint(weight_file_path, save_best_only=True, monitor='val_acc'), EarlyStopping(monitor='val_acc', min_delta=0.0001, patience=7, verbose=1, mode='auto')]
        np.save(config_file_path, self.config)
        architecture_file_path = RecursiveRNN3.get_architecture_file_path(model_dir_path)
        open(architecture_file_path, 'w').write(self.model.to_json())
